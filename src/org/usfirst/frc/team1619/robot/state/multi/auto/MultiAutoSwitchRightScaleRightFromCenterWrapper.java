...
public class MultiAutoSwitchRightScaleRightFromCenterWrapper
		extends MultiSubsystemSequencerStateWrapper<MultiAutoSwitchRightScaleRightFromCenter> {
	@Override
	...
	@Override
	protected MultiAutoSwitchRightScaleRightFromCenter createState() {
		return new MultiAutoSwitchRightScaleRightFromCenter(this.getSubsystemIds());
	}

...
public class MultiAutoSwitchRightFromLeftWrapper
		extends MultiSubsystemSequencerStateWrapper<MultiAutoSwitchRightFromLeft> {
	@Override
	...
	@Override
	protected MultiAutoSwitchRightFromLeft createState() {
		return new MultiAutoSwitchRightFromLeft(this.getSubsystemIds());
	}

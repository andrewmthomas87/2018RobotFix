...
public class MultiAutoSwitchLeftFromLeftWrapper
		extends MultiSubsystemSequencerStateWrapper<MultiAutoSwitchLeftFromLeft> {
	@Override
	...
	@Override
	protected MultiAutoSwitchLeftFromLeft createState() {
		return new MultiAutoSwitchLeftFromLeft(this.getSubsystemIds());
	}

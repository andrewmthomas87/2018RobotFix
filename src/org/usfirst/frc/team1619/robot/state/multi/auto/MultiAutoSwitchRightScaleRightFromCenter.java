...
import org.usfirst.frc.team1619.robot.trajectories.Center_RightScale_CenterCubeToScale_Side;
...
public class MultiAutoSwitchRightScaleRightFromCenter extends MultiSubsystemSequencerState {

	public MultiAutoSwitchRightScaleRightFromCenter(Set<Integer> subsystemIds) {
		super(subsystemIds);
		...
		this.add(new MultiDriveWrapper(
				new DriveTrajectoryWrapper(
						new Trajectory2DDistanceSteps(new Center_RightScale_CenterCubeToScale_Side()), true),
				Constants.ELEVATOR_FLOOR_POSITION, Constants.ARM_PROTECTED_POSITION));
		//

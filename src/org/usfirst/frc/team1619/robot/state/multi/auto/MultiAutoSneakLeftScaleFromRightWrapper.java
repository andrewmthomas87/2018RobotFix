...
public class MultiAutoSneakLeftScaleFromRightWrapper extends MultiSubsystemSequencerStateWrapper<MultiAutoSneakLeftScaleFromRight>{
	...
	@Override
	protected MultiAutoSneakLeftScaleFromRight createState() {
		return new MultiAutoSneakLeftScaleFromRight(this.getSubsystemIds());
	}

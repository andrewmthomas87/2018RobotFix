...
public class MultiAutoSideSwitchRightFromRightWrapper extends MultiSubsystemSequencerStateWrapper<MultiAutoSideSwitchRightFromRight> {
	...
	@Override
	protected MultiAutoSideSwitchRightFromRight createState() {
		return new MultiAutoSideSwitchRightFromRight(this.getSubsystemIds());
	}

...
import org.usfirst.frc.team1619.robot.trajectories.Center_RightScale_CenterCubeToScale_LR_Side;

public class MultiAutoSwitchLeftScaleRightFromCenter extends MultiSubsystemSequencerState {

	public MultiAutoSwitchLeftScaleRightFromCenter(Set<Integer> subsystemIds) {
		super(subsystemIds);
		...
		this.add(new MultiDriveWrapper(
				new DriveTrajectoryWrapper(
						new Trajectory2DDistanceSteps(new Center_RightScale_CenterCubeToScale_LR_Side()), true),
				Constants.ELEVATOR_FLOOR_POSITION, Constants.ARM_PROTECTED_POSITION));

		this.add(new MultiDriveWrapper(new DriveRotateWrapper(75.0, IO.PROFILE_DRIVE_PID_ROTATE_CABLE_GUARD,

...
public class MultiAutoScaleLeftFromLeftWrapper extends MultiSubsystemSequencerStateWrapper<MultiAutoScaleLeftFromLeft> {
	@Override
	...
	@Override
	protected MultiAutoScaleLeftFromLeft createState() {
		return new MultiAutoScaleLeftFromLeft(this.getSubsystemIds());
	}

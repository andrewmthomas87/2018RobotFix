...
public class MultiAutoScaleRightFromRightWrapper
		extends MultiSubsystemSequencerStateWrapper<MultiAutoScaleRightFromRight> {
	@Override
	...
	@Override
	protected MultiAutoScaleRightFromRight createState() {
		return new MultiAutoScaleRightFromRight(this.getSubsystemIds());
	}

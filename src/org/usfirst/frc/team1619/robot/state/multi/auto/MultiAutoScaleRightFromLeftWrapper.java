...
public class MultiAutoScaleRightFromLeftWrapper
		extends MultiSubsystemSequencerStateWrapper<MultiAutoScaleRightFromLeft> {
	@Override
	...
	@Override
	protected MultiAutoScaleRightFromLeft createState() {
		return new MultiAutoScaleRightFromLeft(this.getSubsystemIds());
	}

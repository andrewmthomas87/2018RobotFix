...
import org.usfirst.frc.team1619.robot.trajectories.Right_LeftScale_FenceCube6ToScale;
import org.usfirst.frc.team1619.robot.trajectories.Right_LeftScale_RightToScale;
import org.usfirst.frc.team1619.robot.trajectories.Right_LeftScale_ScaleToFenceCube6;

public class MultiAutoScaleLeftFromRight extends MultiSubsystemSequencerState {

	public MultiAutoScaleLeftFromRight(Set<Integer> subsystemIds) {
		super(subsystemIds);

		this.add(
				new MultiDriveZeroThenIdleWrapper(
						new DriveTrajectoryWrapper(new Trajectory2DDistanceSteps(new Right_LeftScale_RightToScale()),
								true),
		...
		this.add(new MultiDriveAndIntakeWrapper(new DriveTrajectoryWrapper(
				new Trajectory2DDistanceSteps(new Right_LeftScale_ScaleToFenceCube6()), false)));

		this.add(new MultiDriveTwoSetWrapper(
				new DriveTrajectoryWrapper(new Trajectory2DDistanceSteps(new Right_LeftScale_FenceCube6ToScale()), true),

...
public class TalonSRXMotor implements Motor {
	...
	public TalonSRXMotor(TalonSRX motor, NeutralMode neutralMode, boolean isInverted, int peakCurrent, int continuousCurrent, int currentDuration, int timeoutMs) {
		this.motor = motor;
		this.motor.setNeutralMode(neutralMode);
		this.motor.configPeakCurrentLimit(peakCurrent, timeoutMs);
		this.motor.configContinuousCurrentLimit(continuousCurrent, timeoutMs);
		this.motor.configPeakCurrentDuration(currentDuration, timeoutMs);
		this.motor.enableCurrentLimit(false);
